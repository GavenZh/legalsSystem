...
LOAD XML LOCAL INFILE 'E:/test/legalsys/src/main/resources/static/stature/penalLaw.xml' INTO TABLE statureTable;
LOAD DATA LOCAL INFILE 'E:/test/legalsys/src/main/resources/static/stature/accu.txt' INTO TABLE accusationTable FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n';
LOAD DATA LOCAL INFILE 'E:/test/legalsys/src/main/resources/static/stature/dispute.txt' INTO TABLE disputeTable FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n';
